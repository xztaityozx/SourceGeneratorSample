...
"""
    ...
    private static void Generate(
        ...
        foreach (var syntaxContext in source.Right) {
            ...
            generatedClasses.Add(typeSymbol.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat));
...
partial class {{typeSymbol.Name}}
{
    ...
    public static async global::System.Threading.Tasks.Task<string> PerlPackageSourceGenerator_GeneratePerlAsync(string baseDir) 
    {
...
namespace PerlPackageSourceGenerator
{
    ...
    {
        public static async global::System.Threading.Tasks.Task GenerateAsync(string baseDir) 
        {
            var tasks = new global::System.Collections.Generic.List<global::System.Threading.Tasks.Task<string>>();
            {{string.Join("\n", generatedClasses.Distinct().Select(c => $"tasks.Add({c}.PerlPackageSourceGenerator_GeneratePerlAsync(baseDir));"))}}
...
""";
        ...
        context.AddSource("PerlPackageGenerator.Transpiler.g.cs", transpilerCode);
    }
